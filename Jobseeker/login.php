...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($user_login_err) && empty($user_password_err)) {
    ...
    $sql = "SELECT CIN, pseudo, pass_word FROM demandeur_cv WHERE pseudo = ? OR email = ?";
      ...
      <div class="col-lg-5">
        ...
        <div class="form-wrap border rounded p-4" style="background-color: #0000ff1a;">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <div class="mb-3">
              <input style="with: 120px;background-color: #008000ba;" type="submit" class="btn btn-primary form-control" name="submit" value="Log In">
            </div>
            <div class="mb-3">
    <a style="with: 120px;margin-left:10%;" href="../index.php" class="btn btn-secondary form-control">Back to Home</a>
  </div>
  </div>
